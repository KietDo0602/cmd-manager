...
void SettingsDialog::setupAppearanceTab() {
    ...
    m_themeCombo->addItem(tr("Solarized Dark"), SettingsManager::SolarizedDark);
    m_themeCombo->addItem(tr("Solarized Light"), SettingsManager::SolarizedLight);
    m_themeCombo->addItem(tr("Pastel"), SettingsManager::Pastel);
    m_themeCombo->addItem(tr("Nature"), SettingsManager::Nature);
    m_themeCombo->addItem(tr("Nord"), SettingsManager::Nord);
    m_themeCombo->addItem(tr("Paper"), SettingsManager::Paper);
    m_themeCombo->addItem(tr("Rose Pine"), SettingsManager::RosePine);
    m_themeCombo->addItem(tr("Night Owl"), SettingsManager::NightOwl);
    m_themeCombo->addItem(tr("Horizon"), SettingsManager::Horizon);
    m_themeCombo->addItem(tr("Monochrome"), SettingsManager::Monochrome);
    m_themeCombo->addItem(tr("Neon"), SettingsManager::Neon);
    m_themeCombo->addItem(tr("Rainbow"), SettingsManager::Rainbow);
...
void SettingsDialog::setupTerminalTab() {
    ...
    m_terminalColorSchemeCombo->addItem(tr("Nord"), SettingsManager::Nord2);
    m_terminalColorSchemeCombo->addItem(tr("Solarized Dark"), SettingsManager::SolarizedDark2);
